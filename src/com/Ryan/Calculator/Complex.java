...
public class Complex
{
	...
	public double epsilon; // The tolerance for comparisons. Can be changed if a cerrain Complex is known to need a different epsilon
	// All instances of Complex created by a method of another will inherit the parent epsilon.
	
	static public double default_epsilon = 1E-6; // The default tolerance for all new Complex's. Can be chanfed if all or most will need a different epsilon. Defaults to a reasonable value
